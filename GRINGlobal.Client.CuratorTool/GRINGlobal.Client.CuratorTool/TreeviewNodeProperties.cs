...
namespace GRINGlobal.Client.CuratorTool
{
    public partial class TreeviewNodeProperties : Form
    {
        ...
        private void TreeviewNodeProperties_Load(object sender, EventArgs e)
        {
            ...
            // Next DYNAMIC_FOLDER_SEARCH_CRITERIA...
            ...
            // Finally dynamic folder Resove To settings...
            if (ux_textboxDYNAMIC_FOLDER_SEARCH_CRITERIA.Text.Trim().Length > 0)
            {
                switch (GetTreeviewNodeProperty("DYNAMIC_FOLDER_RESOLVE_TO", _currentNode).Trim().ToUpper())
                {
                    ...
                    case "DEFAULT":
                        ...
                        break;
                    default:
                        ux_radiobuttonResolveToOTHER.Visible = true;
                        ux_radiobuttonResolveToOTHER.Checked = true;
                        ux_radiobuttonResolveToOTHER.Text = System.Threading.Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(GetTreeviewNodeProperty("DYNAMIC_FOLDER_RESOLVE_TO", _currentNode).Trim().ToLower());
                        break;
                }
            }
            else
...
if (ux_radiobuttonResolveToOTHER.Checked) resolveTo = ux_radiobuttonResolveToOTHER.Text.ToLower();
if (ux_textboxDYNAMIC_FOLDER_SEARCH_CRITERIA.Text.Length > 0)
{
...
{
    returnedProperties += "FOLDER; DYNAMIC_FOLDER_RESOLVE_TO=default; DYNAMIC_FOLDER_SEARCH_CRITERIA=; ";
}
