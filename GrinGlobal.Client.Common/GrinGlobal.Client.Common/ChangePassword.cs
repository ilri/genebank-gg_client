...
ggMessageBox.ShowDialog();
        ...
        private void ux_textboxUsername_TextChanged(object sender, EventArgs e)
        {
            if (ux_textboxUsername.Text.Length > 0 &&
                ...
                ux_textboxNewPassword.Text.Equals(ux_textboxConfirmPassword.Text))
            {
        ...
        private void ux_textboxNewPassword_TextChanged(object sender, EventArgs e)
        {
            ...
            if (ux_textboxNewPassword.Text.Length > 0 &&
                ux_textboxConfirmPassword.Text.Length > 0 &&
                !ux_textboxNewPassword.Text.Equals(ux_textboxConfirmPassword.Text))
            {
                ux_labelPasswordMatchWarning.Visible = true;
            }
            else
            {
                ux_labelPasswordMatchWarning.Visible = false;
            }
        }

        private void ux_textboxConfirmPassword_TextChanged(object sender, EventArgs e)
        {
            if (ux_textboxUsername.Text.Length > 0 &&
                ux_textboxCurrentPassword.Text.Length > 0 &&
                ux_textboxNewPassword.Text.Length > 0 &&
