...
namespace OrderForm
{
    ...
    public partial class OrderForm : Form, IGRINGlobalDataForm
    {
...
//public OrderForm(BindingSource bindingSource, bool performLookups, LookupTables lookupTables, bool editMode)
        public OrderForm(BindingSource bindingSource, bool performLookups, SharedUtils sharedUtils, bool editMode)
        {
            InitializeComponent();
...
//_lookupTables = lookupTables;
        ...
        public string PreferredDataview
        {
            get
            {
                return "get_orders; get_order_request";
            }
        }
