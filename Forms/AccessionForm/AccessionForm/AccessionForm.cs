...
namespace AccessionForm
{
    ...
    public partial class AccessionForm : Form, IGRINGlobalDataForm
    {
        ...
        private void AccessionForm_Load(object sender, EventArgs e)
        {
            this.Text = FormName;
        ...
        private void AccessionForm_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        public string PreferredDataview
        {
            get
            {
                return "get_accessions; get_accession";
            }
        }
            ...
            foreach (Binding b in cb.DataBindings)
            {
                foreach (Control ctrl in cb.Parent.Controls)
                {
                        ...
                        ctrl.GetType() == typeof(TextBox))
                    {
                        ...
                        DateTime initDate;
                        if (DateTime.TryParse(ctrl.Text, out initDate))
                        {
                            ctrl.Text = ((DateTime)drv[dateColumnName]).ToString(dateFormat);
                        }
                        else
                        {
                            ctrl.Text = DateTime.Now.ToString(dateFormat);
                        }
                    }
                }
            }
